                          ...
                          {logs.map((log) => (
                            <div key={log.id} className="relative flex items-center gap-4">
                              ...
                              <div className="flex items-center gap-1">
                                <Button variant="ghost" size="icon" aria-label="Edit" onClick={() => openCustomModal(log)} className="h-8 w-8 text-slate-400 hover:text-sky-600 hover:bg-sky-50 rounded-xl">
                                  <Pen className="h-4 w-4" />
                                </Button>
                                <Button variant="ghost" size="icon" aria-label="Delete" onClick={() => setDeleteId(log.id)} className="h-8 w-8 text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-xl">
